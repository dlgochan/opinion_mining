...
print('===================================================')
#1:1 비율로 랜덤 샘플링 수행
# y가 1,2인 샘플 중 682개를 임의로 추출해서 비율을 맞춰줌
# positive 최대 개수가 682개라 그냥 최대한으로 맞춰줌
positive_random_idx = df[df['y']==1].sample(682,random_state=0).index.tolist()
negative_random_idx = df[df['y']==0].sample(682,random_state=0).index.tolist()
